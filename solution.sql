...
SELECT "account_balance", "username" FROM "syntax_practice" WHERE "account_balance" > 0 ORDER BY "account_balance" DESC LIMIT 3;
--6. Get the username and account balance of the 3 users with the lowest balances, sort lowest to highest balance.
SELECT "account_balance", "username" FROM "syntax_practice" WHERE "account_balance" > 0 ORDER BY "account_balance" ASC LIMIT 3;
--7. Get all users with account balances that are more than $100.
SELECT "account_balance", "username" FROM "syntax_practice" WHERE "account_balance" > 100 ORDER BY "account_balance";
--8. Add a new record.
INSERT INTO "syntax_practice" ("username","city","transactions_completed","transactions_attempted", "account_balance")
VALUES('bob', 'minneapolis', 150, 150, 5734.23);
